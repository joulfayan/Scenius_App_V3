...
export default [
  ...
  {
    files: ['*.config.{js,ts}', 'tailwind.config.js', 'vite.config.js', 'postcss.config.js'],
    languageOptions: {
      ecmaVersion: 2020,
      globals: {
        ...globals.node,
  ...
  // JavaScript/JSX files
  {
    ...
    rules: {
      ...
      'react/prop-types': 'off', // Disable prop-types for JSX files
  ...
  // TypeScript/TSX files
  {
    ...
    rules: {
      ...
      ...tseslint.configs.recommended.rules,
      'react/jsx-no-target-blank': 'off',
      'react/prop-types': 'off', // Disable prop-types for TSX files
      'react-refresh/only-export-components': [
        'warn',
        { allowConstantExport: true },
      ],
